...
public class Yeni_Siparis extends javax.swing.JFrame {
    ...
    public void musteriBilgileri(){
         String ma = txtMusteriAdi.getText().trim();
        String ms = txtSoyadi.getText().trim();
        String urun = txtUrun.getText().trim();
        String adet = txtAdet.getText().trim();
        
       String insertQuery = "insert into siparis values(null, '"+ma+"', '"+ms+"', '"+urun+"', '"+adet+"', '')";
        try {
            DB db = new DB();
            ...
            System.err.println("gonderme hatası : " + e);
        }
    }
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(60, 60, 60)
                        .addComponent(txtUrun, javax.swing.GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtAdet, javax.swing.GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtSoyadi, javax.swing.GroupLayout.DEFAULT_SIZE, 274, Short.MAX_VALUE))))
                .addContainerGap())
        );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Yeni_Siparis.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Yeni_Siparis().setVisible(true);
            }
        });
    }
