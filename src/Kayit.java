...
public class Kayit extends javax.swing.JFrame {
    ...
    public void dataGonder(){
        ...
        String insertquery = "insert into admin_bilgiler values(null, '"+adi+"', '"+soyadi+"', '"+mail+"', '"+sifre+"')"; 
        
        try {
            DB db = new DB();
            int yazsonuc = db.baglan().executeUpdate(insertquery);
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Admin Kayıt"));
